...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        results_stats_dic['n_images'] += 1 # total images
        
        if results_dic[key][2] == 1: # matches
            results_stats_dic['n_match'] += 1
            
        if results_dic[key][3] == 1: # pet img is dog
            results_stats_dic['n_dogs_img'] += 1
            if results_dic[key][2]==1: # matches
                results_stats_dic['n_correct_breed'] += 1 
            if results_dic[key][4] == 1: # classifier img is dog
                results_stats_dic['n_correct_dogs'] += 1
        else: # pet img is not dog
            if results_dic[key][4]==0: # classifier img is not dog
