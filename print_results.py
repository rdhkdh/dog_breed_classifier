...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    print("CNN Architecture used: {}".format(model))
    print()
    ...
    for key in results_stats_dic:
        if key[0]=='p':
            print( "Percentage {} = {}".format(key, results_stats_dic[key]) )
        ...
        if results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']:
            for key in results_dic:
                if results_dic[key][3] != results_dic[key][4]:
                    print("Misclassifed dog instance: ", results_dic[key])
        else:
            print("No misclassified dog instances. ")
        ...
        if results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']:
            for key in results_dic:
                if results_dic[key][3]==1 and results_dic[key][4]==1 and results_dic[key][2]==0:
                    print("Misclassified breed instance: ", results_dic[key])
        else:
            print("No misclassified breed instances.")